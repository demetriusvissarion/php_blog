            ...
            <article class="max-w-4xl mx-auto lg:grid lg:grid-cols-12 gap-x-10">
                ...
                <section class="col-span-8 col-start-5 mt-10 space-y-6">
                    <form method="POST" action="/" class="border border-gray-200 p-6 rounded-xl">
                        ...
                        <div class="mt-6">
                            <textarea name="body" class="w-full text-sm focus:outline-none focus:ring border border-gray-200" cols="30" rows="10" placeholder="Quick, think of something to say!"></textarea>
                        </div>
